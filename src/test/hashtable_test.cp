...
// 	assert_equals(this + "[content]", {Pair{key="one", value=1}, Pair{key="two", value=2}, Pair{key="three", value=3}}, to_array(hashtable), _arr_pair_comparator);
// }
...
// 	// assert
// 	assert_equals(this + "[size]", 3, size(hashtable));
// 	assert_equals(this + "[content]", {Pair{key="one", value=1}, Pair{key="three", value=3}, Pair{key="five", value=5}}, to_array(hashtable), _arr_pair_comparator);
// }
